...
# Visibility
We could say it’s because design is a relatively new field, and designers are only recently becoming more visible in their contributions to companies. This makes them less credible, harder to fund, and more difficult to gain trust. This only feels like one third of an explanation at best.<span class="ai-tag" data-tooltip="AI usex: Used AI to compare data"> For example, studies show that roughly 25% of IIT alumni launch startups within five years of graduation, compared to around 7% of NID alumni, highlighting a difference in entrepreneurial exposure and network. </span>
